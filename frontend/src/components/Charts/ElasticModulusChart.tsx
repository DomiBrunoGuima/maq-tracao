...
export default function ElasticModulusChart({ data, rupture, onPointClick }: Props) {
    ...
    <ResponsiveContainer width="100%" height={240}>
      ...
      >
        ...
        <YAxis
          ...
          tick={{ fill: "#475569", fontSize: 10 }}
          stroke="#1e2435"
          label={{ value: "E (MPa)", angle: -90, position: "insideLeft", offset: 10, fill: "#475569", fontSize: 10 }}
        />
